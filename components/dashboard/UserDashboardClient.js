// components/dashboard/UserDashboardClient.js
...
// The component is renamed from UserDashboard to UserDashboardClient
export default function UserDashboardClient({ params }) {
  ...
  // This is guaranteed to have a valid currentUser object because of the AuthWrapper
  const isOwner =
