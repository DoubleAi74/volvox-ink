...
// The component is renamed from PageSlugView to PageViewClient
export default function PageViewClient({ params }) {
    ...
    const loadPageData = async () => {
      ...
      if (profileUser) {
        ...
        if (pageData) {
          ...
          // AuthWrapper guarantees currentUser is available here
